...
export default {
    ...
    methods: {
        addProduct(){
            axios.post(this.hostname + '/api/ApiProducts', {collection_id: this.collectionId, name: this.name, desc: this.desc, img: this.img, price: this.price}).then((data)=>this.productId = data.data);
            this.step = 2
        },
